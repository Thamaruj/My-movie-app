...
export default function Index() {
  return (
    <View className="flex-1 justify-center items-center">
         <Text className="text-5xl text-green-600">Hello World!</Text>
         ...
         <Link href="/movie/id" className="bg-blue-500 px-6 py-3 rounded-full">
           <Text className="text-white text-lg">Go to Movies</Text>
         </Link>
         <Link href="/movies" className="bg-blue-500 mt-4 px-5 py-3 rounded-full">
            <Text className="text-white">Dummy Link</Text>
        </Link>
